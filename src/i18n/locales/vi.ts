...
export const vi = {
  ...
  export: {
    ...
    sheets: {
      ...
      strengthProgress: 'Tiến độ sức mạnh',
      liftMaxes: '1RM',
    },
    strength: {
      week: 'Tuần',
      bodyWeight: 'Cân nặng (kg)',
      topKg: '{{lift}} nặng nhất (kg)',
      ratio: '{{lift}} × cân nặng',
      date: 'Ngày',
      lift: 'Bài',
      kg: 'Mức tạ (kg)',
  ...
  settings: {
    ...
    summary: {
      on: 'bật',
      off: 'tắt',
      language: '{{name}} · tự dịch món: {{auto}}',
      body: '{{weight}} kg · {{height}} cm · {{age}} tuổi',
      bodyGoal: ' · mục tiêu {{goal}} kg',
      notificationsOn: 'Nhắc {{time}} · báo pin < {{pct}}%',
      notificationsOff: 'Đang tắt',
      mealRange: '{{label}} {{start}}–{{end}}h',
      data: 'Excel · Món của tôi · dọn dữ liệu',
      interface: 'Chủ đề {{theme}} · hiệu ứng {{fx}}',
    },
    language: {
    ...
    notifications: {
      ...
      thresholdLabel: 'Báo khi pin dưới',
    ...
    data: {
      tileWeekly: 'Excel 7 ngày',
      tileMonthly: 'Excel 30 ngày',
      tileCleanup: 'Xoá dữ liệu > 35 ngày',
      cleanupInfo: 'Xoá vĩnh viễn dữ liệu cũ hơn 35 ngày cho máy nhẹ hơn. Nên xuất Excel trước để giữ bản lưu.',
    ...
    disclaimerShort: '⚠️ Chỉ để tham khảo — không phải thiết bị y tế.',
  },
  ...
  screens: {
    ...
    history: {
      ...
      weekBalanceLabel: 'Cân bằng kcal {{days}} ngày đã xong:',
      weekBalanceValue: '{{kcal}} kcal (≈ {{kg}} kg)',
      weekBalanceNone: 'Chưa đủ dữ liệu ăn uống để tính cân bằng kcal.',
      dayA11y: '{{date}}: đạt {{met}}/{{total}} mục tiêu, cân bằng {{balance}}',
      weekHint: 'Số giữa vòng = mục tiêu đạt trong ngày · chạm một ngày để xem chi tiết',
      batteryShortLabels: {
        protein: 'Đạm',
        carbs: 'Carb',
        water: 'Nước',
  ...
  components: {
    ...
    foodLogModal: {
      ...
      futureTimeError: 'Giờ ăn không thể ở tương lai.',
      lateLogHint: '🕓 Pin no/đói sẽ tính từ lúc {{time}}, không phải lúc ghi.',
      logDateFieldLabel: 'Ngày ghi',
    ...
    customFoodFields: {
      ...
      basisLabel: 'Nhập dinh dưỡng theo',
      basisOptionPer100: '100{{measure}}',
      basisOptionPerServing: '1 {{unit}}',
      basisOptionPerServingSized: '1 {{unit}} ({{measure}})',
      basisHintPer100:
        'Gõ đúng số trên nhãn “/100{{measure}}”. App tự nhân theo khẩu phần khi ghi món.',
      basisHintPerServing:
        'Gõ tổng dinh dưỡng của 1 khẩu phần. App tự quy về /100{{measure}} để lưu.',
      basisNeedsServingSize: 'Nhập kích cỡ khẩu phần ở trên để lưu theo khẩu phần.',
      previewPerServingTitle: '≈ {{serving}} ({{measure}}):',
      previewPer100Title: '≈ Mỗi 100{{measure}}:',
      previewLine: '{{kcal}} kcal · Đạm {{protein}}g · Béo {{fat}}g · Carbs {{carb}}g',
      macroKcal: 'Kcal',
      macroProtein: 'Đạm (g)',
      macroFat: 'Béo (g)',
    ...
    bodyProfileCard: {
      ...
      stepsLabel: 'Bước chân TB/ngày (0-{{max}})',
      ...
      goalWeeksLabel: 'Trong bao lâu (tuần, {{min}}-{{max}}, trống = an toàn nhất)',
    ...
    powerliftingSheet: {
      ...
      variationSectionTitle: 'Biến thể',
      variationStandard: 'Chuẩn',
      customVariationChip: '✍️ Tự đặt tên',
      customVariationPlaceholder: 'Tên biến thể (vd. Spoto press)',
      addVariation: '＋ Thêm biến thể',
      removeMovement: 'Xoá biến thể này',
    },
    bodybuildingSheet: {
    ...
    weightLogCard: {
      ...
      subtitle:
        'Tự nguyện, không bắt buộc. ▲▼ so với lần cân cách đây từ 7 ngày trở lên — xanh là đang về gần mức cân phù hợp.',
      weightPlaceholder: 'Ví dụ: 65',
      logButton: 'Ghi nhận hôm nay',
      datePlaceholder: 'Hôm nay',
      dateLabel: 'Ngày cân (để trống là hôm nay, vd. 14.09)',
      logForDate: 'Ghi cho {{date}}',
      dateInvalid: 'Ngày không hợp lệ hoặc ở tương lai. Gõ dạng 14.09 hoặc 14.09.2026.',
      emptyText: 'Chưa ghi cân nặng nào.',
      editModalTitle: 'Sửa cân nặng',
      editModalTitleDate: 'Sửa cân nặng ngày {{date}}',
      deleteButton: 'Xoá lần cân này',
      deleteConfirmTitle: 'Xoá lần cân này?',
      deleteConfirmMessage: '{{kg}} kg ngày {{date}} sẽ bị xoá khỏi lịch sử cân nặng.',
      suspiciousBadge: '⚠︎ kiểm tra lại?',
      suspiciousA11y: 'Số này lệch hẳn so với lần cân trước và sau, có thể gõ nhầm',
      entryCount: '{{count}} lần ghi',
      scrollHint: 'Kéo trong khung để xem các tháng trước',
      monthSummary: 'TB {{avg}} kg · {{count}} lần',
      chartA11y: 'Biểu đồ cân nặng theo thời gian',
      range1m: '1 tháng',
      range3m: '3 tháng',
      range1y: '1 năm',
      rangeAll: 'Tất cả',
      legendHealthy: 'Giới hạn trên mức phù hợp · {{kg}} kg',
      legendOver: 'Vượt mức phù hợp {{over}} kg · {{kg}} kg',
      healthyBandNote:
        'Vùng tô xanh: cân nặng phù hợp với chiều cao {{height}} cm (BMI 18.5–24.9 theo WHO).',
      chartDisclaimer: 'Đây chỉ là tham khảo, hãy gặp chuyên gia y tế.',
      chartHint: 'Chạm vào đường hoặc điểm trên biểu đồ để xem chú thích',
      pointInfo: '{{date}} · {{kg}} kg',
      healthyInfoDetail: 'BMI 24.9 theo WHO, với chiều cao {{height}} cm.',
    },
    batteryRing: {
      centerValue: '{{done}}/{{total}}',
      centerLabel: 'đạt mục tiêu',
    },
  },
  ...
  blockBuilder: {
    summaryWeekDatesTitle: 'Lịch các tuần (sửa được sau trong Kế hoạch):',
    ...
    blockNumberLabel: 'Đây là block số',
    blockNumberInvalid: 'Nhập một số từ 1 trở lên.',
    currentWeekLabel: 'Bạn đang ở tuần thứ',
    currentWeekHint: 'Chọn W1 nếu bắt đầu block mới. Đang tập dở thì chọn tuần hiện tại — app tự lùi ngày bắt đầu và ghép các tuần đã qua vào Sổ tập.',
    summaryBlockNumberLine: 'Block số {{n}}',
    ...
    scheduleEmptyText: 'Ngày nghỉ — chưa có buổi tập.',
    scheduleSwipeHint: '‹ Vuốt ngang để chuyển ngày ›',
    scheduleRoleToggleA11y: 'Đổi bài chính / bài phụ',
    variationPickerTitle: '{{day}} · chọn bài',
    variationSearchPlaceholder: 'Gõ tên bài, VD: bench dừng',
    variationSearchEmpty: 'Không có bài nào khớp.',
    ...
    scheduleRoleMain: 'Chính',
    scheduleRoleSecondary: 'Phụ',
  ...
  planAppendix: {
    editedBadge: '✎ theo ý bạn',
    editButton: '✎',
    editA11y: 'Sửa kế hoạch {{label}}',
    referenceLineRpe: 'Gợi ý của app: {{sets}} · ~{{pct}}% 1RM · RPE {{rpe}} ở set cuối',
    referenceLineDeload: 'Gợi ý của app (deload): {{sets}} · ~{{pct}}% 1RM',
    referenceLineLegacy: 'Gợi ý cũ: {{sets}} · ~{{pct}}% 1RM',
    howCalcTitle: 'Cách app tính',
    calcRpe: 'Mỗi set {{reps}} rep, set cuối ở RPE {{rpe}} (còn {{rir}} rep dự trữ). Qua {{sets}} set cơ mỏi dần: cộng {{fatigue}} rep{{extra}}. Tổng {{rtf}} rep "tới hạn" → theo Epley, %1RM = 1 / (1 + {{rtf}}/30) ≈ {{pct}}%. 1RM {{oneRm}} kg × {{pct}}%{{factor}}, làm tròn 2,5 kg → {{weight}} kg.',
    calcExtra: ', thêm {{extra}} rep vì tập sau bài chính',
    calcFactor: ' × {{factor}} (biến thể nhẹ hơn bài chuẩn)',
    calcPrime: 'Prime: một lần đơn ~{{pct}}% 1RM ({{weight}} kg) — cao hơn set chính khoảng 20 điểm, giữ trong 82–92%: mức nặng nhất khi khởi động, để cơ thể sẵn sàng mà không mỏi. Hôm đó thực tế khác thì sửa lại.',
    primeBanner: 'Block này chưa có prime gợi ý cho các bài chính. Thêm vào? Bài bạn đã tự sửa vẫn giữ nguyên, chỉ thêm prime phía trước.',
    primeButton: 'Thêm prime',
    calcDeload: 'Tuần deload: lấy %1RM của tuần cuối trừ 10 điểm (còn ~{{pct}}%) và giảm một nửa số set để cơ thể hồi phục.',
    calcLegacy: 'Block này được tạo bằng công thức cũ (%1RM cố định theo bảng, không tính độ mỏi qua các set). Bấm "Cập nhật gợi ý" ở đầu trang để tính lại.',
    legacyBanner: 'Block này được tạo bằng công thức cũ, mức tạ có thể nặng hơn thực tế. Tính lại gợi ý theo công thức mới (theo RPE và độ mỏi qua các set)? Những bài bạn đã tự sửa vẫn giữ nguyên.',
    refreshButton: 'Cập nhật gợi ý',
    weekDatesButton: '✎ Ngày',
    session: {
      confirm: '✓ Sẽ tập',
      confirmPast: '✓ Đã tập',
      inLog: '✓ Có trong Sổ tập',
      planned: '⏰ {{hour}}:00',
      plannedMoved: '⏰ {{date}} · {{hour}}:00',
      logged: '✓ Đã ghi vào Xả',
      missing: 'Đã dời/xoá trong Sổ tập',
      todayTitle: 'Buổi hôm nay',
      todayMessage: 'Bạn tập xong chưa? Ghi ngay vào Xả, hoặc để app tự ghi lúc {{hour}}:00 hôm nay.',
      logNow: 'Đã tập xong — ghi ngay',
      logEvening: 'Tự ghi lúc {{hour}}:00',
      plannedMessage: 'App sẽ tự ghi buổi này vào Xả và Sổ tập lúc {{hour}}:00, {{date}}.',
      move: 'Đổi ngày',
      cancel: 'Huỷ xác nhận',
      missingMessage: 'Buổi này đã được ghi vào Xả, sau đó bị dời hoặc xoá trong Sổ tập.',
      relog: 'Ghi lại vào Xả',
      moveTitle: 'Dời buổi tập {{week}}',
      moveLabel: 'Ngày tập mới',
      moveHint: 'Nhập dd.mm. App tự ghi vào Xả lúc 18:00 ngày đó; ngày đã qua thì ghi ngay.',
    },
    editSheet: {
      title: '{{label}} · {{week}}',
      inputLabel: 'Kế hoạch của bạn',
      placeholder: 'vd. 110x1 5x5x95',
      hint: 'Viết như trong Notes: 5x5x72.5 (set×rep×tạ) · 110 (1 rep) · 3x100 (rep×tạ) · 6x4(+3)x75 · 110x(4+5+5). Nối các cụm bằng dấu cách hoặc +. Prime: 95 + 4x6x72.5 (prime trước set chính).',
      emptyError: 'Nhập ít nhất một set.',
      parseError: 'Không hiểu "{{token}}".',
      previewTitle: 'App hiểu là {{count}} set:',
      previewLine: '{{weight}} kg × {{reps}}',
      previewPrimeLine: 'Prime {{weight}} kg × 1',
      previewSummary: '≈ {{kcal}} kcal · set nặng nhất ~{{pct}}% 1RM',
      copySuggestion: '📋 Chép gợi ý của app',
      restoreSuggestion: 'Khôi phục gợi ý của app',
    },
    weekDates: {
      title: 'Ngày của {{week}}',
      startLabel: 'Từ ngày',
      endLabel: 'Đến ngày',
      hint: 'Các tuần sau tự dời theo tuần này, mỗi tuần giữ nguyên số ngày của nó.',
      laterWeeks: 'Sau khi lưu, các tuần sau:',
      errorEndBeforeStart: 'Ngày kết thúc phải từ ngày bắt đầu trở đi.',
      errorOverlapsPrevious: 'Tuần này phải bắt đầu sau {{date}} (ngày cuối của tuần trước).',
      errorTooLong: 'Một tuần dài tối đa {{max}} ngày.',
    },
    title: 'Phụ lục Kế hoạch',
    weekLabel: 'Tuần {{number}}',
    deloadBadge: 'Deload',
    thisWeekBadge: 'tuần này',
    kcalLine: '~{{kcal}} kcal',
    epocNote:
  ...
  trainingLog: {
    periodEditA11y: 'Sửa hoặc chia sẻ trang {{title}}',
    monthMenu: {
      rename: 'Đổi tên tháng',
      deleteBlock: 'Xoá {{title}}',
      deleteConfirmTitle: 'Xoá {{title}}?',
      deleteConfirmMessage:
        'Kế hoạch block ({{start}}–{{end}}) sẽ bị xoá, cả trong 📋 Kế hoạch block. Các buổi đã ghi vẫn giữ nguyên trong tháng, chỉ mất nhãn B·W của block.',
    },
    pageShare: 'Chia sẻ',
    pageShareTitle: 'Sổ tập luyện',
    pageEmpty: 'Chưa có gì để hiện.',
    addEntryButton: '＋ Ghi buổi',
    formatButtonLabel: 'Định dạng sổ',
    editWeekNoteButton: '✎ Ghi chú tuần',
    weekEditA11y: 'Ghi buổi hoặc ghi chú cho tuần {{label}}',
    progress: {
      title: 'Tiến độ sức mạnh',
      subtitle: 'Mức tạ nặng nhất mỗi tuần · bài chuẩn S/B/D · {{weeks}} tuần gần nhất',
      modeKg: 'kg',
      modeRatio: '× cân nặng',
      modeLabel: 'Đơn vị biểu đồ',
      empty: 'Cần ít nhất 2 tuần có Squat / Bench / Deadlift (bài chuẩn) để vẽ biểu đồ.',
      noBodyWeight: 'Chưa có cân nặng để tính tỉ lệ. Hãy ghi cân nặng trước.',
      valueKg: '{{kg}}kg',
      valueRatio: '{{ratio}}×',
      bodyWeight: 'Cân nặng: {{kg}}kg',
      best: 'cao nhất {{value}}',
      tapHint: 'Chạm vào biểu đồ để xem từng tuần.',
      shareButton: '📤 Chia sẻ ảnh',
      shareDialogTitle: 'Chia sẻ tiến độ sức mạnh',
      shareSubtitleKg: 'Mức tạ nặng nhất mỗi tuần (kg)',
      shareSubtitleRatio: 'Mức tạ nặng nhất mỗi tuần (× cân nặng)',
      shareTagline: 'Theo dõi sức mạnh qua từng tuần',
      maxButton: '⭐ Ghi 1RM',
      maxLegend: '★ = 1RM bạn đã ghi (mốc đạt được, không thuộc đường tập)',
      maxBest: '1RM {{value}} · {{date}}',
      chartLabel: 'Biểu đồ tiến độ sức mạnh theo tuần',
      changeTitle: 'So với tuần đầu:',
      changeValue: '{{sign}}{{pct}}%',
      bodyWeightSource: {
        measured: 'trung bình các lần cân trong tuần',
        interpolated: 'ước tính giữa 2 lần cân',
        carried: 'lần cân gần nhất trước đó',
        earliest: 'chưa cân trước tuần này — tạm dùng lần cân đầu tiên',
        profile: 'chưa có lần cân nào — dùng cân nặng hồ sơ',
      },
    },
    maxSheet: {
      title: '⭐ 1RM đã đạt',
      hint: 'Ghi mức tạ tối đa 1 lần (1RM) bạn đạt được. Mỗi lần ghi là một ngôi sao trên biểu đồ, cùng màu với bài.',
      liftLabel: 'Bài',
      weightLabel: 'Mức tạ (kg)',
      weightPlaceholder: 'vd. 180',
      weightInvalid: 'Nhập số kg lớn hơn 0.',
      noteLabel: 'Ghi chú',
      notePlaceholder: 'vd. thi đấu, test cuối block…',
      save: 'Lưu 1RM',
      listTitle: 'Đã ghi',
      empty: 'Chưa ghi 1RM nào.',
      deleteConfirmTitle: 'Xoá 1RM này?',
      deleteConfirmMessage: '{{lift}} {{kg}} ngày {{date}} sẽ bị xoá khỏi biểu đồ.',
      deleteLabel: 'Xoá 1RM',
    },
    pageEdit: {
      editButton: '✎ Sửa trang',
      hint: 'Sửa thẳng trên chữ. Ngày có buổi Xả: buổi đó được cập nhật lại (tính lại kcal và pin). Ngày chưa Xả: dòng đọc được thành bài/set sẽ thành buổi Xả mới (tính kcal và pin), còn lại lưu thành dòng ghi tay. Bạn sẽ xem trước mọi thay đổi rồi mới áp dụng.',
      inputLabel: 'Nội dung trang',
      cancel: 'Huỷ sửa',
      review: 'Xem thay đổi',
      reviewTitle: 'Sẽ cập nhật {{count}} mục',
      reviewHint: 'Kiểm tra lại từng mục, rồi bấm Áp dụng.',
      backfillExplain: 'Tháng này có dòng ghi tay chưa có buổi Xả. Ghi chúng vào Xả để tính kcal, pin và có trong Excel.',
      backfillButton: '⚡ Ghi {{count}} dòng tay vào Xả',
      backfillHint: 'Mỗi dòng ghi tay đọc được sẽ thành một buổi Xả của đúng ngày đó. Kiểm tra rồi bấm Áp dụng.',
      noChanges: 'Không có thay đổi nào.',
      backToEdit: 'Sửa tiếp',
      apply: 'Áp dụng',
      doneTitle: 'Đã cập nhật {{count}} mục',
      done: 'Xong',
      before: 'Trước',
      after: 'Sau',
      emptyValue: '(trống)',
      kcal: 'kcal buổi tập: {{before}} → {{after}}',
      kcalPending: 'kcal buổi tập hiện tại: {{before}} (sẽ tính lại)',
      kcalCreatePending: 'kcal sẽ được tính khi áp dụng',
      target: {
        xa: 'Buổi Xả · tính lại kcal & pin',
        xaCreate: 'Tạo buổi Xả · tính kcal & pin',
        lineText: 'Chữ trong sổ · không đổi pin',
        manualLine: 'Dòng ghi tay · chỉ lưu trong sổ',
        manualRemoved: 'Xoá dòng ghi tay khỏi sổ',
        dayNote: 'Ghi chú ngày',
        weight: 'Cân nặng ngày này · lưu vào mục Cân nặng',
        weekWeight: 'Cân nặng tuần {{label}} · lưu vào mục Cân nặng',
        weekNote: 'Ghi chú tuần {{label}}',
        weekLabel: 'Nhãn tuần {{label}}',
        monthName: 'Tên tháng tập',
        skipped: 'Không áp dụng',
      },
      reason: {
        unparsed: 'Không đọc được “{{detail}}” thành bài/set, nên chỉ lưu chữ. Số liệu Xả giữ nguyên.',
        unparsedManual: 'Không đọc được “{{detail}}” thành bài/set, nên chưa tạo buổi Xả. Chỉ lưu thành dòng ghi tay.',
        wouldEmpty: 'Sửa này sẽ xoá hết bài của một buổi Xả ({{detail}}). Muốn xoá buổi, vào Lịch sử. Chỉ lưu chữ.',
        annotationsKept: 'Giữ nguyên ghi chú “{{detail}}” trong dòng.',
        xaLineRemoved: 'Dòng bị xoá khỏi trang, nhưng buổi Xả không bị xoá. Muốn xoá buổi, vào Lịch sử.',
        xaLineBlank: 'Dòng bị để trống: buổi Xả giữ nguyên, sổ hiện lại dòng tự động.',
        weightNotSynced: 'Trang không xoá lần cân. Muốn xoá hay sửa, vào mục Cân nặng.',
        weightInvalid: 'Cân nặng này không hợp lệ (20–300 kg), bỏ qua.',
        invalidDate: 'Ngày ở tương lai hoặc không tồn tại, bỏ qua.',
        failed: 'Lỗi khi cập nhật: {{detail}}',
      },
    },
    editor: {
      titleAdd: 'Ghi buổi tập',
      titleEdit: 'Sửa dòng ngày {{date}}',
      dateLabel: 'Ngày',
      datePlaceholder: 'dd.mm',
      dateInvalid: 'Nhập ngày dạng dd.mm (hoặc dd.mm.yyyy).',
      lineLabel: 'Nội dung buổi tập',
      linePlaceholder: 'vd. S 120 5x4x100 PD 4x3x80',
      noteLabel: 'Ghi chú dưới ngày',
      notePlaceholder: 'Cảm giác, RPE, giấc ngủ…',
      copyLatest: '📋 Chép buổi gần nhất',
      copyNone: 'Chưa có buổi nào trước ngày này để chép.',
      autoNow: 'Bản tự động hiện tại:',
      useAutoText: 'Dùng bản này',
      dayHasContent: 'Ngày này đã có nội dung — bạn đang sửa nó.',
      manualHint: 'Dòng ghi tay chỉ lưu trong sổ, không tính vào pin năng lượng.',
      createXaLabel: '⚡ Tạo buổi Xả từ dòng này',
      createXaPreview: 'Sẽ tạo buổi Xả gồm:',
      createXaHint: 'Buổi Xả mới được tính kcal và pin của ngày đó, hiện trong Lịch sử, biểu đồ và Excel.',
      createXaUnparsed: 'Chưa tạo được buổi Xả: không đọc được “{{detail}}”. Dòng chỉ lưu trong sổ.',
      editHint: 'Sửa ở đây chỉ đổi chữ trong sổ, không đổi kcal hay pin. Muốn đổi số liệu, bấm “Sửa số liệu”.',
      sessionsTitle: 'Buổi đã ghi ở mục Xả',
      editData: 'Sửa số liệu',
      minutesOnlyHint: 'Buổi tính theo phút: sửa ở màn Lịch sử.',
      restoreAuto: 'Khôi phục dòng tự động',
      deleteLine: 'Xoá dòng này khỏi sổ',
      deleteConfirmTitle: 'Xoá dòng này khỏi sổ?',
      deleteConfirmMessage: 'Dòng bạn viết và ghi chú của ngày này sẽ bị xoá. Buổi tập đã ghi ở mục Xả vẫn còn và sẽ hiện lại dòng tự động.',
    },
    textSheet: {
      weekNoteTitle: 'Ghi chú tuần {{label}}',
      weekNotePlaceholder: 'vd. nghỉ lễ, ngủ ít, giảm tạ…',
      monthNameTitle: 'Tên tháng tập',
      monthNamePlaceholder: 'vd. Power Lifting',
      monthNameHint: 'Để trống để dùng “{{title}}”.',
    },
    formatSheet: {
      title: 'Định dạng sổ',
      labelStyle: 'Tên bài',
      ...
      decimalDot: 'Dấu chấm (72.5)',
      decimalLocale: 'Theo ngôn ngữ (72,5)',
      showPrime: 'Hiện prime (set khởi động nặng nhất)',
      showWarmups: 'Hiện set khởi động',
      showUnit: 'Hiện đơn vị kg',
      showBodyWeight: 'Hiện cân nặng',
      showWeekday: 'Hiện thứ trong tuần',
      showKcal: 'Hiện kcal cuối dòng',
      abbreviations: 'Viết tắt',
      abbreviationsHint: 'Gõ vào ô để đổi cách viết tắt. Để trống để dùng mặc định.',
      preview: 'Xem trước',
    },
    title: 'Sổ tập luyện',
    tabLog: '📓 Sổ tập',
    tabPlan: '📋 Kế hoạch block',
    blockTitle: 'Block {{n}}',
    monthTitle: '{{month}}',
    ...
    emptyWeek: '—',
    emptyState: 'Chưa có buổi tập nào. Bấm 🔥 Xả ở màn Pin hôm nay để ghi buổi đầu tiên, nó sẽ tự xuất hiện ở đây.',
    markManual: 'Dòng ghi tay',
    markEdited: 'Đã sửa tay',
    conflictSourceChanged: 'Buổi tập ngày này đã đổi sau khi bạn sửa tay.',
    conflictXaAdded: 'Ngày này vừa có buổi ghi từ mục Xả.',
    conflictSourceGone: 'Không còn buổi tập nào trong mục Xả cho ngày này.',
    useAuto: 'Dùng dòng tự động',
    keepMine: 'Giữ dòng của tôi',
    merge: 'Gộp',
    useAutoConfirmTitle: 'Bỏ dòng bạn đã viết?',
    useAutoConfirmMessage: 'Dòng bạn viết cho ngày này sẽ được thay bằng dòng tự động từ mục Xả. Ghi chú dưới ngày vẫn giữ.',
    weekNoteLabel: 'Ghi chú tuần',
    format: {
      dayDate: '{{dd}}.{{mm}}',
      minutes: '{{n}} phút',
      weightUnit: 'kg',
