...
export const vi = {
  ...
  planAppendix: {
    ...
    editSheet: {
      ...
      hint: 'Viết như trong Notes: 5x5x72.5 (set×rep×tạ) · 110 (1 rep) · 3x100 (rep×tạ) · 6x4(+3)x75 · 110x(4+5+5). Nối các cụm bằng dấu cách hoặc +.',
  ...
  trainingLog: {
    ...
    blockMenu: {
      rename: 'Đổi tên',
      delete: 'Xoá block này',
      deleteConfirmTitle: 'Xoá {{title}}?',
      deleteConfirmMessage:
        'Kế hoạch block ({{start}}–{{end}}) sẽ bị xoá, cả trong 📋 Kế hoạch block. Các buổi đã ghi không mất — chúng về lại tháng tập tự do.',
    },
    pageShare: 'Chia sẻ',
    ...
    textSheet: {
      ...
      blockNameTitle: 'Tên block',
      blockNamePlaceholder: 'vd. Block2 Accumulation',
      blockNameHint: 'Để trống để dùng “Block {{n}}”.',
    ...
    blockTitle: 'Block {{n}}',
    freePeriodTitle: 'Tập tự do · {{month}}',
