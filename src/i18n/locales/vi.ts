...
export const vi = {
  ...
  trainingLog: {
    ...
    pageEdit: {
      ...
      hint: 'Sửa thẳng trên chữ. Ngày có buổi Xả: buổi đó được cập nhật lại (tính lại kcal và pin). Ngày chưa Xả: lưu thành dòng ghi tay. Bạn sẽ xem trước mọi thay đổi rồi mới áp dụng.',
      ...
      reason: {
        ...
        weightNotSynced: 'Cân nặng không sửa được từ trang. Hãy sửa ở mục Cân nặng.',
        invalidDate: 'Ngày ở tương lai hoặc không tồn tại, bỏ qua.',
        titleNotEditable: 'Không đổi được tên của tháng tập tự do.',
